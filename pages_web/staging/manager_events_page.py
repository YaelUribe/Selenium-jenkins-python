...
class EventsManager(BasePage):
    ...
    event_list = (By.XPATH, "//app-events-list//div[@class= 'section-content has-padding ng-star-inserted']")
    ...
    select_property_locator = (By.XPATH, "//ng-select[@formcontrolname='space_group_id']//div[@class='ng-value-container']")
    ...
    def go_to_events_page(self):
        """Go to events module"""
        try:
            self.is_visible_fast(util.manager_home_icon)
    ...
    def click_view_details(self):
        time.sleep(1)
        self.do_click_at_index(self.view_details, 2)
