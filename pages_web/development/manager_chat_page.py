...
class ChatManager(BasePage):
    ...
    select_manager_options = (By.XPATH, "//ng-dropdown-panel//span[contains(text(), 'Jose Manager')]")
    ...
    def resolve_chat(self):
        ...
        self.do_click(self.confirm_btn)
        time.sleep(4)
        return self.is_visible(self.status_tag)
    ...
    def filter_by_assigned_to(self):
        ...
        time.sleep(3)
        self.do_click(self.assigned_option)
        time.sleep(0.8)
    ...
    def filter_by_own_advanced(self):
        time.sleep(0.8)
        self.send_keys(self.advance_my_filter, "Abimbola")
        self.press_enter_web()
        time.sleep(1)
        try:
            return self.is_visible(self.first_my_chats)
