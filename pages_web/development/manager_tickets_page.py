...
class TicketsManager(BasePage):
    ...
    tickets_found = (By.XPATH, "//span[contains(text(), 'All Tickets')]")
    ...
    technician_name = (By.XPATH, "//ng-dropdown-panel//span[contains(text(),'Technician Dvora')]")
    ...
    edit_ticket_tag = (By.XPATH, "//app-request-detail-move-out-v2/div//a[contains(text(), 'Edit Ticket')]")
    ...
    move_in_url = "http://development.dvoraliving.com/m/move-in/list"
    move_out_url = "http://development.dvoraliving.com/m/move-out/list"
    unit_member_text = "Ashley Rathappillil"
    time_slot_text = "9"
    time_slot_text_2 = "1"
    inspection_time_text = str(random.randint(1, 7)) + "00P"
    ...
    def new_move_in_ticket(self, date):
        self.go_to_move_in()
        time.sleep(10)
        self.do_click(self.new_ticket_btn)
        time.sleep(0.5)
