from pages_web.development.manager_chat_tickets_and_bookings import ChatTicketsManager
...
class TestChatManager(BaseTest):
    ...
    def test_go_to_chat_page(self):
        ...
        assert self.manager_chat.is_visible(ChatTicketsManager.status_tag)
